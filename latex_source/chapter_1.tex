...
\\
\noindent
The second visualization, the Document Similarity Graph (Figure \ref{fig:similarity_graph}), maps the intellectual structure of the field. Each node is a paper, sized by its PageRank score, and connections represent citations.
...
\noindent
The graph reveals a dense central cluster where foundational Deep Reinforcement Learning algorithms—from pioneers like Schulman \footcite{schulman2017proximal}, Haarnoja \footcite{haarnoja2018soft}, and Lillicrap \footcite{lillicrap2015continuous}—are adapted for V2G control. Woven into this same cluster are key papers on Model Predictive Control (MPC), such as \footcite{parisio2014mpc} and \footcite{borrelli2017predictive}, visually confirming the crucial conversation between these two strategies. Surrounding this core are other vital works, including foundational control theory \footcite{Richalet1978ModelPH} and specialized research on battery degradation \footcite{vetter2005ageing, birkl2017degradation}. This map validates the thesis's focus and situates its contributions within this dynamic, ongoing discussion.
