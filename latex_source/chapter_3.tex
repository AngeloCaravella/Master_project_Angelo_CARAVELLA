...
\begin{itemize}
    \item \textbf{Linear and Quadratic MPC:} The \texttt{run\_experiments.py} script allows choosing between an MPC based on a linear optimization model (\texttt{OnlineMPC\_Solver}) or a quadratic one (\texttt{OnlineMPC\_Solver\_Quadratic}), depending on the desired complexity of the objective function.
