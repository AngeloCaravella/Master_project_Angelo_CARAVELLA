...
At each time step $t$\cite{borrelli2017predictive}, given the current state measurement $x(t)$, the MPC law is defined by solving a constrained finite-time optimal control problem (FTOCP).
